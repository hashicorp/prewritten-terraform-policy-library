...
This rule is covered by the [network-firewall-policy-default-action-full-packets](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/network-firewall/network-firewall-policy-default-action-full-packets.policy.hcl) policy.
