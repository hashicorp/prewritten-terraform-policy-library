...
This rule is covered by the [dms-endpoint-ssl-configured](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/dms/dms-endpoint-ssl-configured.policy.hcl) policy.
