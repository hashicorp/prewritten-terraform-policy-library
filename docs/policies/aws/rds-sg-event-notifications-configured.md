...
This rule is covered by the [rds-sg-event-notifications-configured](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/rds/rds-sg-event-notifications-configured.policy.hcl) policy.
