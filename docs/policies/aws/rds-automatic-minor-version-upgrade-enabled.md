...
This rule is covered by the [rds-automatic-minor-version-upgrade-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/rds/rds-automatic-minor-version-upgrade-enabled.policy.hcl) policy.
