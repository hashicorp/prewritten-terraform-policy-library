...
This rule is covered by the [transfer-connector-logging-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/transfer/transfer-connector-logging-enabled.policy.hcl) policy.
