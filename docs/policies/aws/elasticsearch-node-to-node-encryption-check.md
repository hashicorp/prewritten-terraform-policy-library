...
This rule is covered by the [elasticsearch-node-to-node-encryption-check](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/elasticsearch/elasticsearch-node-to-node-encryption-check.policy.hcl) policy.
