...
This rule is covered by the [kms-cmk-not-scheduled-for-deletion-2](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/kms/kms-cmk-not-scheduled-for-deletion-2.policy.hcl) policy.
