...
This rule is covered by the [ec2-docker-registry-endpoint](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/ec2/ec2-docker-registry-endpoint.policy.hcl) policy.
