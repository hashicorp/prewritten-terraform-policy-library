...
```bash
trace:
      # ssm-document-not-public.policytest.hcl... running
      # resource.aws_ssm_document.pass_no_permissions... running
      # resource.aws_ssm_document.pass_no_permissions... pass
      ...
      # resource.aws_ssm_document.pass_not_self_owned... running
      # resource.aws_ssm_document.pass_not_self_owned... pass
      # resource.aws_ssm_document.pass_empty_account_ids... running
      # resource.aws_ssm_document.pass_empty_account_ids... pass
      # resource.aws_ssm_document.fail_all_with_specific... running
      # resource.aws_ssm_document.fail_all_with_specific... pass
      # ssm-document-not-public.policytest.hcl... pass
```
