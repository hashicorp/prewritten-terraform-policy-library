...
This rule is covered by the [cloudfront-traffic-to-origin-encrypted](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/cloudfront/cloudfront-traffic-to-origin-encrypted.policy.hcl) policy.
