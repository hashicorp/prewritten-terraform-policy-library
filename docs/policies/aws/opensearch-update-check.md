...
This rule is covered by the [opensearch-update-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/opensearch/opensearch-update-check.policy.hcl) policy.
