...
This rule is covered by the [redshift-serverless-workgroup-routes-within-vpc](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/redshift/redshift-serverless-workgroup-routes-within-vpc.policy.hcl) policy.
