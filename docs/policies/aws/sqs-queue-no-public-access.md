...
This rule is covered by the [sqs-queue-no-public-access](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/sqs/sqs-queue-no-public-access.policy.hcl) policy.
