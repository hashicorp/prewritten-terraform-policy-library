...
This rule is covered by the [opensearch-access-control-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/opensearch/opensearch-access-control-enabled.policy.hcl) policy.
