...
This rule is covered by the [autoscaling-launch-template](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/autoscaling/autoscaling-launch-template.policy.hcl) policy.
