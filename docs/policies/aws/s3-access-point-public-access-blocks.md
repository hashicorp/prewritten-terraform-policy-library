...
This rule is covered by the [s3-access-point-public-access-blocks](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/s3/s3-access-point-public-access-blocks.policy.hcl) policy.
