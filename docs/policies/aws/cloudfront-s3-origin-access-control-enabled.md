...
This rule is covered by the [cloudfront-s3-origin-access-control-enabled](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/cloudfront/cloudfront-s3-origin-access-control-enabled.policy.hcl) policy.
