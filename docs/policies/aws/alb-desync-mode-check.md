...
This rule is covered by the [alb-desync-mode-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/elb/alb-desync-mode-check.policy.hcl) policy.
