...
This rule is covered by the [waf-global-rule-not-empty](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/waf/waf-global-rule-not-empty.policy.hcl) policy.
