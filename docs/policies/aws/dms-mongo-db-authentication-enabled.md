...
This rule is covered by the [dms-mongo-db-authentication-enabled](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/dms/dms-mongo-db-authentication-enabled.policy.hcl) policy.
