...
This rule is covered by the [dms-replication-task-sourcedb-logging](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/dms/dms-replication-task-sourcedb-logging.policy.hcl) policy.
