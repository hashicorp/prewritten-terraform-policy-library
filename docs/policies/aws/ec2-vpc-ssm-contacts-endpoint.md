...
This rule is covered by the [ec2-vpc-ssm-contacts-endpoint](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/ec2/ec2-vpc-ssm-contacts-endpoint.policy.hcl) policy.
