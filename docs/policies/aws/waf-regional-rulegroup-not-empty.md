...
This rule is covered by the [waf-regional-rulegroup-not-empty](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/waf/waf-regional-rulegroup-not-empty.policy.hcl) policy.
