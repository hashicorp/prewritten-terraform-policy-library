...
This rule is covered by the [rds-postgresql-logs-to-cloudwatch](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/rds/rds-postgresql-logs-to-cloudwatch.policy.hcl) policy.
