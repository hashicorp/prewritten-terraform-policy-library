...
This rule is covered by the [lambda-vpc-multi-az-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/lambda/lambda-vpc-multi-az-check.policy.hcl) policy.
