...
This rule is covered by the [waf-global-webacl-not-empty](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/waf/waf-global-webacl-not-empty.policy.hcl) policy.
