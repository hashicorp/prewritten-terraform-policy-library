...
This rule is covered by the [fsx-openzfs-deployment-type-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/fsx/fsx-openzfs-deployment-type-check.policy.hcl) policy.
