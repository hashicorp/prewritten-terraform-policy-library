...
This rule is covered by the [dms-neptune-iam-authorization-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/dms/dms-neptune-iam-authorization-enabled.policy.hcl) policy.
