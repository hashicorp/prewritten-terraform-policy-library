...
This rule is covered by the [route53-query-logging-enabled](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/route53/route53-query-logging-enabled.policy.hcl) policy.
