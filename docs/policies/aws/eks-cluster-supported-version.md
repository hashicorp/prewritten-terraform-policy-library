...
This rule is covered by the [eks-cluster-supported-version](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/eks/eks-cluster-supported-version.policy.hcl) policy.
