...
This rule is covered by the [macie-status-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/macie/macie-status-check.policy.hcl) policy.
