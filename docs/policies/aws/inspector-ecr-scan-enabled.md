...
This rule is covered by the [inspector-ecr-scan-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/inspector/inspector-ecr-scan-enabled.policy.hcl) policy.
