...
This rule is covered by the [guardduty-ecs-protection-runtime-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/guardduty/guardduty-ecs-protection-runtime-enabled.policy.hcl) policy.
