...
This rule is covered by the [guardduty-ecs-protection-runtime-enabled](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/guardduty/guardduty-ecs-protection-runtime-enabled.policy.hcl) policy.

## Policy Results

```bash
trace:
      # guardduty-ecs-protection-runtime-enabled.policytest.hcl... running
      # resource.aws_guardduty_detector_feature.pass_runtime_monitoring_with_ecs_fargate_enabled... running
      # resource.aws_guardduty_detector_feature.pass_runtime_monitoring_with_ecs_fargate_enabled... pass
      # resource.aws_guardduty_detector_feature.fail_ecs_fargate_disabled... running
      # resource.aws_guardduty_detector_feature.fail_ecs_fargate_disabled... pass
      ...
      # resource.aws_guardduty_detector_feature.fail_no_additional_configuration... running
      # resource.aws_guardduty_detector_feature.fail_no_additional_configuration... pass
      ...
      # resource.aws_guardduty_organization_configuration_feature.pass_org_runtime_monitoring_with_ecs_fargate_enabled... running
      # resource.aws_guardduty_organization_configuration_feature.pass_org_runtime_monitoring_with_ecs_fargate_enabled... pass
      # resource.aws_guardduty_organization_configuration_feature.fail_org_ecs_fargate_disabled... running
      # resource.aws_guardduty_organization_configuration_feature.fail_org_ecs_fargate_disabled... pass
      ...
      # resource.aws_guardduty_organization_configuration_feature.fail_org_no_additional_configuration... running
      # resource.aws_guardduty_organization_configuration_feature.fail_org_no_additional_configuration... pass
      # guardduty-ecs-protection-runtime-enabled.policytest.hcl... pass
```
