...
This rule is covered by the [opensearch-https-required](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/opensearch/opensearch-https-required.policy.hcl) policy.
