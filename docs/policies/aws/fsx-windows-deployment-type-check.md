...
This rule is covered by the [fsx-windows-deployment-type-check](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/fsx/fsx-windows-deployment-type-check.policy.hcl) policy.
