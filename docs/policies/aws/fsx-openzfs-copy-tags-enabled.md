...
This rule is covered by the [fsx-openzfs-copy-tags-enabled](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/fsx/fsx-openzfs-copy-tags-enabled.policy.hcl) policy.
