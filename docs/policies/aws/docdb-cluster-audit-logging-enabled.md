...
This rule is covered by the [docdb-cluster-audit-logging-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/docdb/docdb-cluster-audit-logging-enabled.policy.hcl) policy.
