...
This rule is covered by the [waf-global-rulegroup-not-empty](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/waf/waf-global-rulegroup-not-empty.policy.hcl) policy.
