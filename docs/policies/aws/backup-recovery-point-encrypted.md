...
This rule is covered by the [backup-recovery-point-encrypted](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/backup/backup-recovery-point-encrypted.policy.hcl) policy.
