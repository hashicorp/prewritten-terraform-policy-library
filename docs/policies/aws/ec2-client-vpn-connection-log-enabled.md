...
This rule is covered by the [ec2-client-vpn-connection-log-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/ec2/ec2-client-vpn-connection-log-enabled.policy.hcl) policy.
