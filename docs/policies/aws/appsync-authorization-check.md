...
This rule is covered by the [appsync-authorization-check](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/appsync/appsync-authorization-check.policy.hcl) policy.
