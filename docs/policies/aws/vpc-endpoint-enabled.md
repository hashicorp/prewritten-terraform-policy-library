...
This rule is covered by the [vpc-endpoint-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/ec2/vpc-endpoint-enabled.policy.hcl) policy.
