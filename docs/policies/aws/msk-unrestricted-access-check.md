...
This rule is covered by the [msk-unrestricted-access-check](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/msk/msk-unrestricted-access-check.policy.hcl) policy.

## Policy Results

```bash
trace:
      # msk-unrestricted-access-check.policytest.hcl...
      running
