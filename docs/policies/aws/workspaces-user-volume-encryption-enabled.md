...
This rule is covered by the [workspaces-user-volume-encryption-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/workspaces/workspaces-user-volume-encryption-enabled.policy.hcl) policy.
