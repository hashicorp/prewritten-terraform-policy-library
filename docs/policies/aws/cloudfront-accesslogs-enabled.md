...
This rule is covered by the [cloudfront-accesslogs-enabled](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/cloudfront/cloudfront-accesslogs-enabled.policy.hcl) policy.
