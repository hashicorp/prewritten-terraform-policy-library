...
This rule is covered by the [efs-access-point-enforce-user-identity](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/efs/efs-access-point-enforce-user-identity.policy.hcl) policy.
