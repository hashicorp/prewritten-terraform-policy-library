...
This rule is covered by the [rds-instance-event-notifications-configured](https://github.com/hashicorp/prewritten-terraform-policy-library/blob/main/policies/aws/rds/rds-instance-event-notifications-configured.policy.hcl) policy.

## Policy Results

```bash
trace:
      # rds-instance-event-notifications-configured.policytest.hcl... running
      ...
      # resource.aws_db_event_subscription.fail_unspecified_source_missing_categories... running
      # resource.aws_db_event_subscription.fail_unspecified_source_missing_categories... pass
      ...
      # resource.aws_db_event_subscription.pass_enabled_default_true... running
      # resource.aws_db_event_subscription.pass_enabled_default_true... pass
      # resource.aws_db_event_subscription.pass_extra_categories... running
      # resource.aws_db_event_subscription.pass_extra_categories... pass
      # rds-instance-event-notifications-configured.policytest.hcl... pass
```
