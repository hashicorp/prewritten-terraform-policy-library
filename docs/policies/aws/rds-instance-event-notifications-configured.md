...
This rule is covered by the [rds-instance-event-notifications-configured](https://github.com/hashicorp/policy-library-for-tfpolicy/blob/main/policies/rds/rds-instance-event-notifications-configured.policy.hcl) policy.
