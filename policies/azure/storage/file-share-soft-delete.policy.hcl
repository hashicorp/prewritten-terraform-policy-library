...
resource_policy "azurerm_storage_account" "file_share_soft_delete" {
  locals {
    ...
    retention_days_raw   = core::try(local.retention_policy_raw[0].days, core::try(local.retention_policy_raw.days, null))
    retention_days       = local.retention_days_raw != null ? local.retention_days_raw : 0
    has_valid_retention_period = local.retention_days_raw != null && local.retention_days >= 1 && local.retention_days <= 365
