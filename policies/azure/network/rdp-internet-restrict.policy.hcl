...
resource_policy "azurerm_network_security_group" "restrict_rdp_from_internet" {
  locals {
    ...
    internet_source_rules = [for rule in local.inbound_allow_rdp_protocol_rules : rule if core::contains(["0.0.0.0/0", "Internet", "*"], core::try(rule.source_address_prefix, "")) || core::length([for source in (core::try(rule.source_address_prefixes, null) != null ? core::try(rule.source_address_prefixes, []) : []) : source if core::contains(["0.0.0.0/0", "Internet", "*"], source)]) > 0]

    violating_rules = [for rule in local.internet_source_rules : rule if core::try(rule.destination_port_range, "") == "3389" || (core::try(core::parseint(core::try(core::split("-", core::try(rule.destination_port_range, ""))[0], ""), 10), -1) <= 3389 && core::try(core::parseint(core::try(core::split("-", core::try(rule.destination_port_range, ""))[1], ""), 10), -1) >= 3389) || core::length([for port_range in (core::try(rule.destination_port_ranges, null) != null ? core::try(rule.destination_port_ranges, []) : []) : port_range if port_range == "3389" || (core::try(core::parseint(core::try(core::split("-", port_range)[0], ""), 10), -1) <= 3389 && core::try(core::parseint(core::try(core::split("-", port_range)[1], ""), 10), -1) >= 3389)]) > 0]
  }
