...
resource_policy "aws_rds_cluster" "audit_logging_enabled" {
  ...
  enforce {
    ...
    error_message = "Aurora MySQL cluster references parameter group which is not found in the configuration. Ensure the parameter group is defined. Refer to https://docs.aws.amazon.com/securityhub/latest/userguide/rds-controls.html#rds-45 for more details."
  }
