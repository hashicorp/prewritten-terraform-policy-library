...
policytest {
    targets = [
        "sagemaker-model-quality-job-encrypt-in-transit.policy.hcl"
    ]
}

# Test 1: PASS - ModelQuality monitoring with encryption enabled
...
# Test 2: FAIL - ModelQuality monitoring with encryption disabled
...
# Test 3: FAIL - ModelQuality monitoring without network_config
