...
resource_policy "aws_sagemaker_monitoring_schedule" "model_explainability_inter_container_encryption" {
    ...
    enforce {
        ...
        error_message = "SageMaker model explainability monitoring schedule does not have inter-container traffic encryption enabled. Set 'monitoring_schedule_config.monitoring_job_definition.network_config.enable_inter_container_traffic_encryption = true' to protect data transmitted between containers during distributed model explainability monitoring jobs. Refer to https://docs.aws.amazon.com/securityhub/latest/userguide/sagemaker-controls.html#sagemaker-10 for more details."
    }
}
